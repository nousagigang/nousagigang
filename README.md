# Nousagi Gang
Text-based MMORPG Gaming Group Website

> **Nousagi [NSG]** *or Nousagi Gang* — A Filipino community of text-based MMORPG players. 🇵🇭
...
- Default subdomains:
    - Production: **[nousagigang.web.app](https://nousagigang.web.app)** *([Firebase Hosting](https://firebase.google.com/))*
    - Preview: [nousagigang.firebaseapp.com](https://nousagigang.firebaseapp.com) *([Firebase Hosting](https://firebase.google.com/))*
